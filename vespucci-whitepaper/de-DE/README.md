...
Die relativ jüngste Explosion an Kryptowährungen hat große Popularität angezogen und mehr Menschen werden sich der Vorteile gegenüber der Fiat-Währung bewusst. Die ständig steigende Anzahl an Plattformen, die Kryptowährungen unterstützen und Transaktionen zwischen einer großen Bandbreite an Produkten und Services erlauben, ziehen viele Nutzer an, die eine neue, dynamische Generation von Händlern bilden, für die die komplizierten Feinheiten der Blockchain-Technologie transparent sind. Um sich in der komplexen Welt der Kryptowährungen zurechtzufinden, könnten neue Nutzer ebenso wie erfahrene Investoren sehr von einem System profitieren, welches Kryptowährungen evaluiert und ein Ranking erschafft, das als Investment-Guide, mit nutzer-definierten Parametern personalisiert, genutzt werden kann. Vespucci ist ein neues System, das über die vorgenannten Funktionen hinausgeht. Insbesondere überwacht es die Entwicklung der Blockchain- und Kryptowährungsmärkte und, durch Nutzung der Macht fortschrittlicher KI und Maschinen-Lern-Technologie, liefert es unvoreingenommene, robuste und aktuelle Rankings, die den echten Wert eines sehr großen Spektrums an Coins repräsentieren, um so als Prognostiker ihrer zukünftigen Kurse zu agieren. Dieses Ranking-System ist in dem Sinne vollständig, dass es aus einer großen Reihe von Quellen schöpft, kategorisiert in drei Säulen, namentlich Stimmungsanalyse, grundlegende und technologische Analyse und technische Analyse. Vespucci ist Teil des integrierten Ökosystems von Volentix, das um die dezentralisierte Exchange-Plattform VDex herum geschaffen wurde; letzte beinhaltet eine Sammlung von Smart-EOS.IO-Contracts, um schnelle und sichere Transaktionen, Nutzeranonymität, Liquidität, Skalierbarkeit, Performance und Bewertung von Gewinnmargen zu schaffen. Dieses Whitepaper präsentiert einen ausführlichen Überblick darüber, wie Vespucci funktioniert, einschließlich einer Diskussion zu verschiedenen technischen Aspekten, und es hebt auch die verschiedenen Wege hervor, die genutzt werden können.

* ### **ÜBERBLICK**

Vespucci ist Teil des Volentix-Ökosystems. Insbesondere implementiert es eine der Haupt-Säulen des Volentix-Ökosystems, deren Dreh- und Angelpunkt VDex ist. VDex ist eine dezentralisierte Exchange-Börse, die den Nutzer und die Community im Blickfeld hat. Vespucci ist, neben seiner Funktion als Audit digitaler Assets und als Bewertungsinstrument, welches Nicht-Experten zugänglich ist, auch ein Werkzeug um handelbare digitale Assets abzubilden und gegenüberzustellen. Moreover, it provides a dashboard for cryptocurrencies’ activity in the digital world.
