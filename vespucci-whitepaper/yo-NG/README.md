...
Ọpọlọpọ imọ ẹrọ ni yoo se lo fun ipele yii, bi o tilẹ jẹ pe nipa wiwa ni ibamu pẹlu didena ọpọlọpọ oriṣiriṣi awọn imọ ẹrọ to ṣe pataki lati ni oye gbogbo eto naa, ati lilo awọn imo ẹrọ ti o jẹ mimulo-jakejado, yiyan iru imọ ẹrọ naa gẹgẹbi ipele isinmi opin pẹlu eyiti ẹrọ yii n ba ṣepọ yoo jẹ ọlọgbọn. A **node.js-based** module would thus be a wise choice, though other implementation technologies are certainly possible. Also, Ruby on Rails offers an extremely agile way to create REST APIs as well.
