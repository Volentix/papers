...
**Ifaagun ti Fibonacci:** Wọn jẹ awọn irinṣẹ asọtẹlẹ to lokiki, wọn ma n ni ọpọ igba jẹ lilo ni apapọ pẹlu awọn ilana atẹ idiju miran. Ọpọlọpọ awọn onisowo n lo ilana yii ni apapọ pẹlu ẹkọ to da lori igbi (Elliott Wave, Wolfe Wave) lati ṣe iṣiro bi igbi kọọkan ṣe ga to ati lati ṣetumọ oriṣiriṣi awọn igbi. They commonly used with other chart patterns such as the ascending triangle. Once the pattern is identified, a forecast can be created by adding 61.8% of the distance between the upper resistance and the base of the triangle to the entry price.
