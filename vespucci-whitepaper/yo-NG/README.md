...
Eyi n ṣe idaniloju pe ẹya ohun elo Vespucci SA ni anfani lati ṣe abojuto ọpọlọpọ imọran awọn eniyan. Afiwe awọn abajade naa laarin awọn akoko ti wakati kan, ọjọ kan ati ọsẹ kan ma jẹ sise. The outputs are available through APIs for internal use by other Vespucci components such as the front-end web UI as well as to external users that want to consume the data or build third-party applications based on Vespucci.
