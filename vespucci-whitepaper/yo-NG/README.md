...
**Awọn iṣupọ Fibonacci:** Iṣupọ Fibonacci jẹ oke tente ti adapada fun igba diẹ ti Fibonacci lati oriṣiriṣi awọn ibi giga ati awọn ibi kukuru to se pataki ni akoko kan. Atọ ila olukuluku awọn ipele Fibonacci wọnyi lẹhinna jẹ ṣiṣe lori ila "Y" (idiyele). Each overlapping retracement level makes a darker shade on the cluster – the darker the cluster is, the more significant the support or resistance level tends to be. This technique can be used in conjunction with other Fibonacci techniques or chart patterns to confirm support and resistance levels.
