...
Para subukan ang Vespucci sa isang pagpapalabas sa semi-public gamit ang mga propektibo na mga boluntaryo, ang sistem ay ipinakilala sa iba't ibang mga gumagamit sa labas para sa bug pagsubok ng pagtatasa ng mga function ng sistem, at ang UI. Ito ay isinasagawa sa isang pampublikong setting sa pamamagitan ng organisasyon ng isang saradong pag-release ng beta. Users are selected to allow for more constructive and relevant feedback information.‬ ‪An ongoing iterative process of tweaks, fixes, and adjustments will take place during the beta release from the insight derived from user feedback.‬
