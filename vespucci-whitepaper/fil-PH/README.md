...
* Ang pamamahagi ng coin, kasama ang impormasyon kung paano ibinahagi ang coin sa mga tagapag-develop, ang pundasyon/produksyon, at ang publiko. Also, the rate of change of the total supply and how is then distributed seems to provide useful statistics on the actual value of the coin and indication of possible frauds.
