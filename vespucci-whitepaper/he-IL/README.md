...
התוצרים של שלושת המרכיבים יחד עם תנועות המחיר המקביל (בהיות המחיר חסין לסיכונים) למסגרות שונות נותנים זכות קדימה לדירוג מטבעות הקריפטו והטוקנים בגישה ההוליסטית ביותר שניתן להשיג עד כה. This is coupled with Post-processing for humans.
...
[4] C.J. & Gilbert et al. VADER: מודל מבוסס-חוק מחפיר הנועד לניתוח סנטימנט של תכני מדיה חברתית. כנס בינלאומי בבלוגים ובמדיה חברתית (2014) 8 (ICWSM-14)
