...
**Relative Strength Index (RSI)** is a momentum indicator that measures the magnitude of recent price changes to analyze overbought or oversold conditions. It is primarily used to attempt to identify overbought or oversold conditions in the trading of an asset. ה-RSI מספק הערכה יחסית בנוגע לחוזק ביצועי המחירים האחרונים באבטחה, מה שהופך אותו לאינדיקטור מניע. שווי RSI שווה ל-70 ומעלה, מצביע על כך שביטחון מתקדם אל עבר ''קניית-יתר'' או ''הערכת יתר''. RSI reading below or equal to 30 is commonly interpreted as indicating an oversold or undervalued condition that may signal a trend change or corrective price reversal to the upside. סוחרים מסוימים, בניסיון להימנע מאותות שווא של הRSI, משתמשים בערכי RSI יותר קיצוניים כאותות קניה ומכירה, כגון קריאות RSI מעל 80 המצביעות על תנאי ''קניית-יתר'', וקריאות RSI מתחת ל20 המצביעות על תנאי ''מכירת-יתר.''. תנודות גדולות ופתאומיות במחיר עלולות ליצור אותות קניה ומכירה שקריות בתוך הRSI. זהו, אם כך, ניתן לשימוש הטוב ביותר עם חידודים ליישום שלו או בשילוב עם אינדיקטורים טכניים מאשרים, אחרים.
...
** תוספי פיבונאצ'י:** הם כלים פופולאריים לחיזוי, המשמשים לעתים קרובות בשילוב עם דפוסים טכניים תרשימיים אחרים. סוחרים רבים משתמשים בטכניקה זו בשילוב עם מחקרים מבוססי-גלים (Elliott Wave, Wolfe Wave) בכדי להעריך את את הגובה של כל גל ולהגדירו. They commonly used with other chart patterns such as the ascending triangle. Once the pattern is identified, a forecast can be created by adding 61.8% of the distance between the upper resistance and the base of the triangle to the entry price.
