...
מאזיני דעת הקהל של Vespucci רצים על-גבי VMs מבוססי-cloud המסוגלים לשנות את היקף העבודה באופן מיידי ולטפל בכל עומסי העבודה הפוטנציאליים. בדרך זו, Vespucci מטפל ומעבד את אמצעי האחסון המסיביים, אך יקרי-הערך, הקשורים לסוגי מטבעות-קריפטו הנוצרים בכל רגע נתון. מקביליות היא מפתח בעת טיפול במידע מאסיבי וארכיטקטורה ממנפת המקבילות של Vespucci, שרשורים מרובים ומשניים בכל מקום אפשרי. שירותי-מיקרו וקודים ללא-שרת רצים במקביל על מנת לתכנן את הליכי העיבוד וזרימות הנתונים.

בשלב השני, כלי ניקוד עוברים תהליך התאמה ושיפור בכדי למקד את הפונקציונליות שלהם במטבעות-קריפטו, אשר בסופו של דבר יביא לפיתוח התוכנה שלנו תחת משימה זו. יתר על כן, חלק מן האחסון משמש ( ראה חלק</a> רלוונטי) עבור צבור נתונים הדרושים בכדי (א) לבצע השוואות היסטוריות (ב) להכשיר את הרשת העצבית הסובבת שמייצרת את התוצאה הסופית. על פי כן (א), נוכל לעשות שימוש בהיסטוריה של כל אסימון מאז היווצרותו. בנוסף (ב), למידה עמוקה זקוקה למכסה נתונים תקופתי של עד כשנתיים.</p> 

בסופו של דבר, Vespucci יבוא אל קהילת הקוד הפתוח בניסיון להפוך את הפלטפורמה למבוזרת במידה רבה יותר. הכוונה היא לבצע ביזור בפונקציונליות של הניקוד הרגשי ושל העיבוד הנתוני, בכדי לספק תוצאות בטוחות ואמינות המובלות על-ידי הקהילה.

![](https://volentix.io/file/2019/01/a.jpg)

על-ידי מינוף מסגרת הלמידה הממוחשבת של "Python", ובהינתן יתרונות השפה, טבעי יהיה בעבור מודול זה להתיישם בתוכנת ה"Python". הוא מתנהל עם ספריות למידה מסוימות של למידה ממוחשבת כגון Scikit-learn, TensorFlow, CNTK, Torch, Theano, וKeras.

חוויית משתמש שתהיה מקושרת אל הפורום הציבורי של מטבעות-קריפטו נמצאת תחת פיתוח בכדי לספק הודעות וסטטיסטיקות עדכניות של פעילות קהילתית. ניתן להניב מהציון הסופי פונקצית ניקוד. טכניקות לימוד ממוחשבות מוחלות על מנת לספק ניתוח סנטימנטליות בזמן אמת
