...
**רצועות בולינגר** הינם אינדיקטור תרשים טכני פופולרי בקרב הסוחרים על גבי כמה שוקים פיננסיים. בתרשים ישנם שתי ''רצועות'' שמקבצות את מחיר השוק. רבים משתמשים בהם בעיקר בכדי לקבוע רמות ''קניית-יתר'' ו-''מכירת-יתר''. A common strategy is to sell when the price touches the upper Bollinger Band and buy when it hits the lower band. This technique also called range-bound markets. In this type of market, the price bounces off the Bollinger Bands like a ball bouncing between two walls.
