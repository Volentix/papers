...
דנו כבר בנושא שלושת התת-מערכות העיקריות של ניתוח טכנולוגי/בסיסי, טכני, ורגשי. שלושת עמודי התווך אינם מושלמים. יתר על כן, רק האנליסטים המנוסים ביותר יכולים לשלב את כל שלושת המערכות עם שיטת דירוג אחת. התוצאה הסופית לכל מטבע קריפטו תלויה בכוח של כל אחד משלושת הרכיבים, ונשקלים על פי ערכי ברירות מחדל או לפי המשתמש. כיוון שאנו מאמינים בערך הטכנולוגיה ובערך של הצוות מאחורי כל מטבע ממוחשב, FTA, ובמיוחד בהיבטים הטכנולוגיים העומדים על משקל כולל של 50% ברירת מחדל. בעזרת ביסוס על מחקר וניסויי הערכה של פרמטרים, משקלים מותאמים נגזרים בכמות מדודה של ערך המטבע. אנו מנצלים את פריצות הדרך האחרונות ב''רשתות עצביות עמוקות'' על מנת להפוך את שילוב התוצאות לאוטומטי, ללא התערבות אנושית, וכך גם להימנע מחד- צדדיות ישירה או עקיפה.

התוצרים של שלושת המרכיבים יחד עם תנועות המחיר המקביל (בהיות המחיר חסין לסיכונים) למסגרות שונות נותנים זכות קדימה לדירוג מטבעות הקריפטו והטוקנים בגישה ההוליסטית ביותר שניתן להשיג עד כה. זה מצומד לעיבוד-אחרי עבור בני-אדם.
