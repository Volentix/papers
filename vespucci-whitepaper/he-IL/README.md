...
**Relative Strength Index (RSI)** is a momentum indicator that measures the magnitude of recent price changes to analyze overbought or oversold conditions. It is primarily used to attempt to identify overbought or oversold conditions in the trading of an asset. ה-RSI מספק הערכה יחסית בנוגע לחוזק ביצועי המחירים האחרונים באבטחה, מה שהופך אותו לאינדיקטור מניע. שווי RSI שווה ל-70 ומעלה, מצביע על כך שביטחון מתקדם אל עבר ''קניית-יתר'' או ''הערכה יתר על מידה''. RSI reading below or equal to 30 is commonly interpreted as indicating an oversold or undervalued condition that may signal a trend change or corrective price reversal to the upside. סוחרים מסוימים, בניסיון להימנע מאותות שווא של הRSI, משתמשים בערכי RSI יותר קיצוניים כאותות קניה ומכירה, כגון קריאות RSI מעל 80 המצביעות על תנאי ''קניית-יתר'', וקריאות RSI מתחת ל20 המצביעות על תנאי-יתר. תנודות גדולות מחיר פתאומיות עלולות ליצור אותות קניה ומכירה שקריות בתוך הRSI. זהו, אם כן, ניתן לשימוש הטוב ביותר עם חידודים ליישום שלה או בשילוב עם אחרים, המאשר אינדיקטורים טכניים.

**רצועות בולינגר** הינם אינדיקטור תרשים טכני פופולרי בקרב הסוחרים על גבי כמה שוקים פיננסיים. בתרשים ישנם שתי ''רצועות'' שמקבצות את מחיר השוק. רבים משתמשים בהם בעיקר בכדי לקבוע רמות ''קניית-יתר'' ו-''מכירת-יתר''. אסטרטגיה ידועה הינה למכור כאשר המחיר נוגע לרצועת ה''בולינגר'' העליונה, ולקנות כשהמחיר מגיע לרצועה התחתונה. טכניקה זו גם נקראת שוקים במגמה אופקית (range-bound markets). בסוג זה של השוק, המחיר קופץ בין ''רצועות בולינגר'' כמו כדור המקפץ בין שני קירות.

**MACD** מחשב את הפרש היתרה של 26 יום לבין ממוצעים מעריכים נעים (EMA) ב12 יום. EMA ה-12 יום הינו המהיר יותר, בעוד שלתהליך ה-26 יום ממוצע הנע באיטיות יותר. חישוב שני סוגי ה-EMA משתמש במחירי הסגירה של כל תקופה נמדדת. On the MACD chart, a nine-day EMA of MACD itself is plotted as well, and it acts as a signal for buy and sell decisions.The MACD histogram provides a visual depiction of the difference between MACD and its nine-day EMA. MACD histogram is one of the main tools traders use to gauge momentum, because it gives an intuitive visual representation of the speed of price movement. For this reason, the MACD is commonly used to measure the strength of a price move rather than the direction or trend of a currency.
...
מספר רב של מטבעות סחירים כיום הם מטבעות ERC20, המיושמים על גבי בלוקצ'יין הEthereum. בנוסף, רבים מן המטבעות ה''מרגשים'' הם חלק ממערכת גדולה יותר של חוזים חכמים אשר משתמשים במטבע ERC20 כמטבע מקומי. מתן ניתוח מעמיק על אלה, וכל מערכת חוזה חכם הנמצאת על גבי הEVM של Ethereum, הינו נורא שימושי למטרות ברמה גבוהה של Vespucci. מודול זה קיים על מנת לצרוך מערכות חוזה-חכם הקשורות אל כמה מטבעות ERC20, בכדי לדרג אותם, ברמת הקוד, על בטיחות כללית, נוכחות של באגים, וגורמים חשובים אחרים אשר יכולים להיבדק עם ניתוח סטטי של קוד החוזה במערכת של חוזים חכמים. הרבה מהיגיון הליבה שלה נרשם ב''Python'', וגשרים רבים מתפתחים בהתאם למודול הסטטיסטיקות של הבלוקצ'יין.

* ### ** חווית המשתמש**

ל-Vespucci ממשק משתמש (UI) המאפשר קלט פרמטר פשוט באופן עקבי, ומציג את ערכי ההערכה שהתקבלו. ממשק הקלט מספק רשימה של כל המטבעות הזמינים או מבחר של מטבעות בדירוג העליון על בסיס שווי השוק: המשתמש יכול לבחור את אלה אשר מביאים לו/לה עניין. באופן חלופי, המשתמש מחויב לספק קישור לבלוקצ'יין ציבורי אחד של מטבעות-קריפטו (או כמה), יחד עם הקישור לקוד המקור של הפרויקט כמו תשומות בסיסיות שונות. סוג ורמת הניתוח שיש לבצע על המטבע הנתון נבחר. ניתוח מפורט יותר, דורש יותר תשומות. ‬

ממשק התוצאות מספק תצוגה מכווצת, המציג אינדקס בעבור חלקים ניתנים להרחבה המראים את הערכים שנבחרו בפירוט. התצוגה המכווצת מציגה את סיכום דירוגי הקוד המקודד של מטבעות-קריפטו. הדירוג המקודד בצבע מחושב על-פי ממוצע משוקלל של כל מדדי ההערכה. כל קטע הניתן להרחבה מציג את הערך או את הקבוצה של ערכים באופן גרפי. ערכי ההערכה מופרדים לסעיפים שונים בהתבסס על המידע המייצג שלהם, כגון נתונים המתייחסים לפרספקטיבה חברתית או לנקודת מבט טכנית. אינדקס אופטימלי של ערכי הערכה נקבעים על מנת לאפשר אינטראקציה אינטואיטיבית של ממשק משתמש, בגישה לנתונים שמעניינים את המשתמש.

בעקבות ההצלחה של ארנק האתריום ודפדפן ה''Mist'' של אתריום, הממשק הראשי נחשף למשתמש נמצא בתוך יישום ה''אלקטרון''. ''אלקטרון'' הינו טכנולוגיה ותיקה אשר הובאה לידי-ייצוג בפני Github על מנת ליצור יישומי שולחן-עבודה מודרניים. כיוון שVespucci אינו קשור כלל לAPI's מבוססי-Desktop ניתן להריצו בדפדפן. הממשק לאפליקציה ניתן לעיצוב באמצעות ספריות UI ותיקות בעבור יישומים מודרניים. עם כל רכיב המתקיים בפני עצמו, פשוט למשוך רכיבים החוצה ולהוסיף חדשים בזמן התנסות עם המוצר בקרב משתמשים מבלי להשפיע לרעה על המוצר בכללותו.
