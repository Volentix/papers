...
* פעילות ותפוצת צמתי רשת. צמתי רשת הינם חלק חיוני מהבלוקצ'יין, כיוון שהם מנוהלים על ידו. הם מחוברים לרשת הבלוקצ'יין, משדרים ומקבלים את ההעברות, וברשותם עותק משלהם של הבלוקצ'יין. לכן, פעילותם, הפצתם וגודלם הממוצע יכולים לספק למידע שימושי על הבלוקצ'יין.
* הפצת מטבע, לרבות מידע על איך המטבע מופץ בקרב המפתחים, צוות היסוד/הייצור, והציבור. כמו כן, שעור השינויים בכלל האספקה וכיצד הוא מופץ לאחר מכן נדמה כי מספק נתונים סטטיסטיים מועילים על ערך המטבע הממשי, ונותן אינדיקציה להונאות אפשריות.
