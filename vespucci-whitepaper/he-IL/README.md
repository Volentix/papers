...
* גודל פונקציית גיבוב נגד קושי כעבור זמן, מחיר וצריכת חשמל. רמיזות אלו, יכולות להציג מתאמים שונים עם גודל פונקציית הגיבוב, כלומר הפונקציה תוכל לעקוב אחר הריבוי המקביל או להפחית למחיר. Networks’ Hash Rate is also a security indicator, since networks which have low hash rate is easier to be tampered.
