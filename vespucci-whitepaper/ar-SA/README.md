...
للحصول على المعلومات الأكثر فائدة حول سلسلة معينة، من الضروري عادة تشغيل عقدة كاملة تراقب كل كتلة قادمة. عند القيام بذلك، يمكن أن تتوفر معلومات في الوقت الفعلي عن أي من الإحصائيات المهمة، بما في ذلك ارتفاع السلسلة، إستنتاج متوسط وقت الكتل ومتوسط تشغيلها، أحجام الكتل، عدد المعاملات وأي عدد من الخصائص الأخرى المعروضة لأي عقدة كاملة. The interface for querying this full node is a decision made by the designers of the client in question, and is thus the responsibility of the blockchain statistics module to conform to this interface to normalize it into a form that can be consumed upstream by modules that are agnostic to the specific interface.
...
توفر واجهة النتائج طريقة عرض مطوية حيث توفر فهرسًا لمختلف الأقسام القابلة للتوسيع والتي تعرض المقاييس المحددة بأتمّ التفاصيل. تعرض طريقة العرض المطوية ملخص تصنيف عملة إلكترونية مشفر بإستخدام مختلف الألوان. يتم حساب التصنيف المشفر باستخدام متوسط مرجّح لجميع مقاييس التقييم. يعرض كل قسم قابل للتوسيع المقياس أو مجموعة المقاييس بطريقة رسومية. يتم تجزئة مقاييس التقييم إلى أقسام مختلفة بناءً على المعلومات الخاصة بها مثل البيانات المتعلقة بالمنظور الاجتماعي أو الفني. An optimal indexing of assessment metrics are determined to allow for intuitive UI interaction in accessing and view data of interest for the user.‬
