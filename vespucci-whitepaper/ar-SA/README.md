...
* NLTK ،Tweepy ،VADER ،TextBlob لتحليل توجه سوق twitter.
...
قد تتضمن مصادر **بيانات** Vespucci على سبيل المثال (لكن لا تنحصر على): سجلات التداول التاريخية، اتجاهات التداول، نشاط المطورين وتحليل الخطة، توزيع الأصول الرقمية ومعلومات الإدارة، الشروط والأحكام، أرصدة العناوين الحالية والتاريخية، هذا بالإضافة إلى منتدى تحليل توجه السوق. يمكن العثور على هذه المعلومات منتشرة بين مواقع مستكشف السلاسل وغرف الدردشة. على وجه الخصوص، تحليل توجه السوق (أنظر إلى [القسم](https://docs.google.com/document/d/1NLr-rgF66NCBmLmPIdElltKYVPJrLVO7DZDpcNEm6OU/edit?ts=5bec2f33#heading=h.tuaauijo691s) المناسب) سيتطلب بيانات عن جميع العملات الرقمية لفترة محدودة من الزمن. This is a vast amount of data and in order to minimise the impact that data will have on the system, we employ big data techniques of compression, aggregation, and filtering.
