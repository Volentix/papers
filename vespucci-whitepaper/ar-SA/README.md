...
أخيرًا، نود ذكر فكرتين متقدمتين لاستخدامهما في هذه المرحلة: (أ) تطبيقات موزعة لمختلف أدوات التعلم بالتزامن مع فلسفة Vespucci اللامركزية. (ب) تجميع الشبكات العصبية التي يمكن استخدامها في واحد أو أكثر من الدعائم الثلاثة في حساب النتيجة النهائية بواسطة أداة شاملة للتعلم الآلي.
