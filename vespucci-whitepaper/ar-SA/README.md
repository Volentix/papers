# الوثيقة البيضاء الخاصة بـVespucci
...
* مقياس التوجه لتحليل نزعة السوق (sentiment analysis or SA)،
* التحليل الفني (technical analysis or TA)، و
* التحليل الأساسي/التكنولوجي (fundamental/technological analysis or FTA).
...
يعتمد تقيم Vespucci وقدرته التحليلية على الدعام الثلاث: تحليل نزعة السوق، التحليل الفني/الاقتصادي والتحليل الأساسي/التكنولوجي. يجمع Vespucci بين هذه الجوانب من أجل توفير التقيم والتصنيف من خلال استخدام تقنية التعلم الآلي والشبكات العصبية (Neural Network أو NN). It offers a service that has never been available before since it integrates all features in the following figure.
