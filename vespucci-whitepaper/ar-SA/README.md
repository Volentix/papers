...
للحصول على المعلومات الأكثر فائدة حول سلسلة معينة، من الضروري عادة تشغيل عقدة كاملة تراقب كل كتلة قادمة. عند القيام بذلك، يمكن أن تتوفر معلومات في الوقت الفعلي عن أي من الإحصائيات المهمة، بما في ذلك ارتفاع السلسلة، إستنتاج متوسط وقت الكتل ومتوسط وقت تشغيلها، أحجام الكتل، عدد المعاملات وأي عدد من الخصائص الأخرى المعروضة لأي عُقدة كاملة. The interface for querying this full node is a decision made by the designers of the client in question, and is thus the responsibility of the blockchain statistics module to conform to this interface to normalize it into a form that can be consumed upstream by modules that are agnostic to the specific interface.
