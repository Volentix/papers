...
* Il tempo di propagazione dei blocchi è importante, poiché i blocchi appena trovati devono essere propagati il più presto possibile sulla rete blockchain. Except for the waiting time for the user, another major issue coming from propagation time is that even for tiny delays‬, another block found at the same time might win the “block race”.
