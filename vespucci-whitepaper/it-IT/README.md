...
Al fine di testare Vespucci in una versione semipubblica utilizzando potenziali volontari, il sistema viene presentato a diversi utenti esterni per il bug testing delle funzioni del sistema di valutazione e dell'interfaccia utente. ‬‪It is carried out in a public setting through the organization of a closed beta release. Users are selected to allow for more constructive and relevant feedback information.‬ ‪An ongoing iterative process of tweaks, fixes, and adjustments will take place during the beta release from the insight derived from user feedback.‬
