...
باستخدام المخزن المؤقت الدائري الخاص ببروتوكول Loopring تقنية (FIFO (first-in first-out، يمكن للعُقد تصميم دفاتر طلباتها لعرض ومطابقة طلب المستخدم. تتبع هذه الطريقة نموذج OTC، حيث يتم وضع طلبات الحدود بناءً على السعر فقط.[5]
...
لا يعتمد Parsec على السجلات (logs) لتحديد الإجماع. من ناحية أخرى، يطلبها RAFT. في أي حال، سيتم تصميم عُقد Validator لتتطلب الحد الأدنى من المعلومات و ذلك لأجل تحديد الإجماع لتقليل وقت عملية المعاملة.
