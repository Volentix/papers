...
توفر بروتوكولات RAFT و PARSEC نظامًا قويًا للقيام بالإسترداد في حالة فشل العُقدة. يتم كذلك توفير تدابير أمنية للتداول بين سلاسل الكتل الأصلية وفيما بينها. إذا كانت السلسلة تتحدى التعريف، فسيتم تعيين النظام افتراضيًا للكتلة التالية أو قفل قصير الأجل (short time lock).
...
كلنا في Volentix نكرس عملنا ورؤيتنا لتطوير برنامج قائم على التمكين والاستقلال. إذا كنت تفكر في الانضمام إلينا، بأية صفة كانت، فيرجى القيام بذلك والرجاء التعرف على المواضيع الواردة في هذه الورقة البيضاء ومنشورات Volentix الإضافية التي نشاركها مع مجتمعنا.
