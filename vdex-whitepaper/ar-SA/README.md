...
تم تخصيص مجمعات VDex كسيرفرات Volentix لأغراض المحاكاة والأمن. تتمثل إحدى وظائفها في سحب السجلات وبيانات دفتر الطلبات من العقد إلى تمثيلات متفرقة موزعة للذاكرة الزمنية الهرمية كتحليل اقتحام [7] لاكتشاف الحالات الشاذة في النظام. سوف تستضيف المجمعات أيضًا مكونات أخرى مثل دفاتر metachain وكاشطات (scrapers) سلسلة الكتل.
