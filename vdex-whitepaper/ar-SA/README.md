...
توفر بروتوكولات RAFT و PARSEC نظامًا قويًا للقيام بالإسترداد في حالة فشل العُقدة. يتم كذلك توفير تدابير أمنية للتداول بين سلاسل الكتل الأصلية وفيما بينها. إذا كانت السلسلة تستعصي على التعريف، فسيقوم النظام بتعيين الكتلة التالية افتراضيًا أو انشاء قفل قصير الأجل (short time lock).
