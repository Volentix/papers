...
האלגוריתמים המתקדמים לזיהוי חריגה שמסופקים על-ידי הספריה של ''Numenta Nupic'', ידרשו פחות ערכות נתונים לאימונים נרחבים מאשר מערכות קונבנציונליות של AI (בינה מלאכותית).
