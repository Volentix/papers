...
ניתן לקבל מידע רב על בלוקצ'יינים, באמצעות איסוף צירי הזמן שלהם בסדר מקביל ( עם שוני בתדירות החלפת המצב [state]). מערכת זו יכולה לעורר עומס שרשורי מרובה, להחליף מצב, להביא תוצרים של נתוני מידע מחוזים חכמים, וביצוע עסקאות זרות. מרחק יחסי בין בלוקים, מצב גלובלי יחסי, וחותמות זמן האירועים נרשמים בלדג'ר עולמי על מנת למטב ולאשר את ההעברות לפני שהן מתרחשות על הרשת המקומית. גישה זו יכולה גם כן לשמש לקביעת צירופי המקרים בהליכי ייצור הבלוקים בין רשתות על מנת לקבל נזילות רבה יותר.[12]

### 3.7 ענייני אבטחה

בכדי להתנער מהנחות מסוימות, אנו מתכננים להתחיל בבדיקת האבטחה לאחר שלב אב-הטיפוס. עניינים הנוגעים לאבטחה מקבלות חשיבות עליונה למשתמשים, ככה שנחוץ לטפל בהם. סוגי איומים כוללים, לדוגמא, מישהו אשר מריץ קוד מזיק בתוך עסקת חליפין, או מניפולציה בסדר ההעברות וחותמות הזמן של בלוקים. בחלקים הבאים, אנו פונים אל כמה איומים ביטחוניים ספציפיים עם אמצעי ביטחון ותקנים.
