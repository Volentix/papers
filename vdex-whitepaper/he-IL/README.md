...
האלגוריתמים המתקדמים לזיהוי חריגה שמסופקים על-ידי הספריה של ''Numenta Nupic'', ידרשו פחות אימונים רחבים לערכות נתונים מאשר מערכות קונבנציונליות של AI (בינה מלאכותית).
