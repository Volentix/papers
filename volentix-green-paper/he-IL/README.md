...
Verto מעוצב כארנק רב-מטבעות לשימוש עם ''חלפן הכספים'' VDex המבוזר, המתוכנן בכדי להקל על ניהול אישי ומקומי של מפתחות פרטיים וציבוריים בעסקאות בין עמית- לעמית. מפתחות פרטיים וציבוריים ינוהלו באופן מקומי, עם המטרה לחיסול כל סיכון של ספיגת אבידות כבדות המשויכות לכשלים טראומטיים של מפעילים מרכזיים. אנא קרא/י את ספר המבוא של Verto על ידי ביקור ב<http://verto.vdex.io/>
